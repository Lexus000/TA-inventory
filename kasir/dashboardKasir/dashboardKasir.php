...
$i2 = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT SUM(subtotal-(subtotal-harga_modal*qty)) as totdpt FROM laporan"));
$i3 = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT SUM(subtotal-harga_modal*qty) as totdpt1 FROM laporan"));
...
<head>
  ...
  <title>
    Inventory Jajanan | Dashboard Kasir
  </title>
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <div class="container-fluid py-4" id="#content">
          ...
          <div class="card card-carousel overflow-hidden h-100 p-0">
            <div id="carouselExampleCaptions" class="carousel slide h-100" data-bs-ride="carousel">
              <div class="carousel-inner border-radius-lg h-100">
                <div class="carousel-item h-100 active" style="background-image: url('../../assets/img/tempe_kripik.jpg');
      background-size: cover;">
                ...
                <div class="carousel-item h-100" style="background-image: url('../../assets/img/kue_kering.jpg');
      background-size: cover;">
                  <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                    <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                ...
                <div class="carousel-item h-100" style="background-image: url('../../assets/img/kue_basah.jpg');
      background-size: cover;">
                  <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                    <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
