...
<body class="g-sidenav-show  bg-gray-100">
                                        ...
                                        ?>
                                                <tr>
                                                    <td class="text-center text-xs  ">
                                                        <?php echo $no++; ?></td>
                                                    <td class="text-center text-xs  ">
                                                        <a href="../transaksiPegawai/invoice.php?detail=<?php echo $oninv ?>"><?php echo $d['invoice']; ?></a></td>
                                                    <td class="text-center text-xs  ">
                                                        <?php
                                                    ...
                                                    <td class="text-center text-xs  ">Rp
                                                        ...
                                                        ?></td>
                                                    <td class="text-center text-xs  ">Rp
                                                        <?php echo ribuan($d['pembayaran']); ?></td>
                                                    <td class="text-center text-xs  ">Rp
                                                        <?php echo ribuan($d['kembalian']); ?></td>
                                                    <td class="text-center text-xs  ">
                                                        <?php echo $d['tgl_inv']; ?></td>
    ...
    if (isset($_POST['Remove'])) {
        ...
        if ($hapus_data_Cart_all && $hapus_data_Cart_all1) {
            echo '<script>;window.location="laporanPegawai.php"</script>';
            //set session sukses
