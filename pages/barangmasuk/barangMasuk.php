...
<head>
  ...
  <title>
    Inventory Jajanan | Barang Masuk
  </title>
                            ...
                            <div class="modal-body">
                              <form method="POST" action="./aksiMasuk.php">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col">
                                    <div class="form-floating mb-3">
                                      <input type="date" class="form-control" id="floatingTextInput2" value="<?= $row['tanggal'] ?>" placeholder="Smith" name="tanggal_masuk" required>
                                      <label for="floatingTextInput2">Tanggal</label>
                                    </div>
                                  </div>
                                  <div class="col">
                                ...
                                <div class="row">
                                  <div class="col mb-4">
                                    <label for="floatingTextInput3">Pengirim</label>
                                    <select class="form-select" aria-label="Default select example" name="pengirim">
                                      <option value="">Pilih ...</option>
                                      <?php
                                      $sql = $koneksi->query("SELECT * from tblsupplier order by id");
                                ...
                                <div class="row ">
                                  <div class="col mb-4">
                                    <div class="form-floating mb-1">
                                      <input type="text" class="form-control" id="floatingTextInput1" placeholder="John" value="<?php echo $jumlah; ?>" name="jumlahmasuk" id="jumlahmasuk">
                                      <label for="floatingTextInput5">Jumlah Masuk</label>
                                    </div>
                                  </div>
                                </div>
                                <div class="modal-footer">
