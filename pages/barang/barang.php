                  ...
                  <div class="modal-body">
                    ...
                    <form method="POST" action="./aksiBarang.php">
                      <div class="row">
                        ...
                        <div class="col">
                          <div class="form-floating mb-3">
                            <input type="date" class="form-control" id="floatingTextInput2" value="<?php echo $tanggal_barang; ?>" placeholder="Smith" name="tanggal_barang" required>
                      ...
                      <div class="row ">
                        <div class="col mb-4">
                          <div class="form-floating mb-1">
                            <input type="text" class="form-control" id="jumlah" value="<?php echo $jumlah; ?>" name="jumlah" required>
                ...
                <table class="table align-items-center  pe-3" id="tableS">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tanggal Barang</th>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="text-center text-xs font-weight-bold "><?= $row['tanggalBarang'] ?></td>
                            ...
                            <div class="modal-body">
                              <form method="POST" action="./aksiBarang.php">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col">
                                    <div class="form-floating mb-3">
                                      <input type="date" class="form-control" id="floatingTextInput2" value="<?= $row['tanggalBarang'] ?>" placeholder="Smith" name="tanggal_barang" required>
                                      <label for="floatingTextInput2">Tanggal</label>
                                    </div>
                                  </div>
                                  <div class="col">
