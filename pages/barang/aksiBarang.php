...
if(isset($_POST['bsimpan'])) {
    ...
    $simpan = $koneksi->query("INSERT into tblbarang (kodeBarang, tanggalBarang, namaBarang, jenisBarang, satuan,hargaModal,hargaJual, jumlah ) values('$kode_barang','$tanggal','$nama_barang','$jenis_barang','$satuan','$harga_modal','$harga_jual','$jumlah')");
